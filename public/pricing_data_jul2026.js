...
// Source: cloud_pricing_20260721_095107.json
...
const CLOUD_PRICING_DATA = 
{
  "metadata": {
    "version": "2026.Q07",
    "generated_at": "2026-07-21T09:51:45Z",
    ...
    "currency": "USD",
    "notes": [
      "Prix récupérés via API officielle",
      "Dernière mise à jour: 21 July 2026",
      ...
      "connectivity": {
        "expressroute": {
          ...
          "gateway": {
            ...
            "scale_unit_gbps": 1,
            "rounding": "ceil",
            "note": "1 Scale Unit = 1 Gbps, arrondi à l'entier supérieur"
          }
        }
      },
      "egress_internet": {
        ...
        "peering_modes": {
          "internet": {
            ...
            "regions": {
              ...
              "indiasouthcentral": {
                "region_name": "Indiasouthcentral",
                "region_code": "indiasouthcentral",
                "zone": "Zone 1",
                "tiers": [
                  {
                    "min_gb": 100.0,
